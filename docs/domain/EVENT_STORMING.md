...
| Disbursement terminal failure | Disbursement | Non-retryable [DE-DS-004](DOMAIN_EVENTS.md#48-disbursement-ds) | POL-LB-003 stop activation and invoke explicit reservation recovery | Create an Active Loan or reinterpret failure as decline | Duplicate terminal facts are harmless | `DisbursementFailed`; proposed [IE-DS-002](DOMAIN_EVENTS.md#58-disbursement-ds) |
...
| HS-004 | Proposed | Disbursement and operations | Recovery after repeated transfer failure | Determines reservation cancellation/expiry and operator authority | Define allowed manual recovery without implying automatic reversal | [Q-009](../discovery/ASSUMPTIONS.md#open-questions) |
| HS-005 | Proposed | Security and contract governance | Sensitive-field classification and retention | Affects public payload allowlists, storage, logs, audit, and DLQs | Classify PII/tokenization and set retention before publication/IaC | [Q-003 and Q-004](../discovery/ASSUMPTIONS.md#open-questions) |
...
| OQ-005 | Proposed | Operations and Disbursement | Repeated-failure manual action | Keeps terminal transfer recovery deliberately unresolved | Define authorized action, evidence, and audit requirements | [Q-009](../discovery/ASSUMPTIONS.md#open-questions) |
| OQ-006 | Proposed | Security and platform architecture | Retention and DLQ treatment | Affects protected artifacts, OTP records, audit evidence, and redrive | Set retention, encryption, deletion, and access rules | [Q-003](../discovery/ASSUMPTIONS.md#open-questions) |
