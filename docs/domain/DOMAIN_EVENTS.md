...
| DE-AP-003 | `CreditOfferAccepted` | Proposed | `CreditApplication` | Applicant accepts the active, unexpired offer and exact terms hash | Application ID, offer ID, accepted terms hash, accepted instant | [BR-AP-006](BUSINESS_RULES.md#4-application-process-ap) | [Phase B](EVENT_STORMING.md#5-phase-b--decision-and-offer) |
